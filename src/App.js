...
class App extends Component {
    render() {
        return ( <
            ...
            animation = "medium" / >
            <
            SubHeader title = "Recreation"
            subContent = { NFTS }
            animation = "slow" / >
            <
            /div> <
            div className = "message-section-title" > Cutting out the banks from the Lending Systems < /div> <
            div className = "message-flex" >
            <
            MessageListContainer / > { /* <div className='round-circle'></div> */ } <
            /div> < /
            div > <
            /div> < /
            Layout >
