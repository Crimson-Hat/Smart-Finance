...
class App extends Component {
    render() {
        return (<
            ...
            <SubHeader padding = "extra-padding"
            title = "Investing"
            ...
            subContent = { book }
            animation = "medium" / >
            <SubHeader title = "NFTs"
            subContent = { park }
            animation = "slow" / >
            </div> <div className = "message-section-title" > Cutting out the banks from the Lending Systems interface. </div> <div className = "message-flex">
            <MessageListContainer / > { /* <div className='round-circle'></div> */ } </div> </div > </div> </Layout>
        );
    }
}
